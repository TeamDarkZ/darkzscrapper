#Telegram Unlimited Members Adder
#Developed Specially for The DarkZ Network
#Developer Credits: @Atharv_xD
...
def banner():
    ...
    print(f'{info}{g} DarkZ Adder V2.1 by Atharva{rs}')
    print(f'{info}{g} Telegram- @Atharv_xD {rs}\n')
def clscreen():
    os.system('cls')
clscreen()
banner()
